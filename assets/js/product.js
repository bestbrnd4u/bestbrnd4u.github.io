...
function updateProductSeoMetadata(product) {
    ...
    if (window.ProductOffer) setJsonLd("productSchema", {
        ...
        // Колір і матеріал — з тієї самої причини, що й category вище:
        // цей рендер замінює розмітку ЦІЛКОМ, тож поле, якого тут
        // немає, зникає зі сторінки після виконання JS, хоч генератор
        // його й поклав. Обидва місця мусять лишатись однаковими.
