...
(function () {
    ...
    // Помилку відгуку теж треба сказати, а не лише показати: форма
    // довга, рядок з'являється під нею, і фокус нікуди не йде.
    // Роль — один раз, наперед: читалка має знати про живу область
    // ДО появи в ній тексту.
