...
// ПІДПИСУ КОЛЬОРУ В КАРТЦІ БІЛЬШЕ НЕМА — це рішення власника.
//
// Тут була функція cardColorLabel(): вона малювала «Бежевий» /
// «Чорний» окремим рядком під назвою. Сенс був у тому, що кожен колір
// — окрема картка, і дві картки одного товару мають однакові бренд,
// назву й ціну.
//
// Чому все одно прибрали: фото вже відповідає на це питання (кремова
// сумка й чорна поруч не схожі), свотчі кольорів на картці лишились, а
// зайвий рядок з'їдав 20 px висоти в кожній картці й розганяв текстовий
// блок. Назва кольору нікуди не зникла: вона є в підказці свотча
// (title), у назві варіанта на сторінці товару і в адресі (?color=).
//
// ЯКЩО ЗАХОЧЕТЬСЯ ПОВЕРНУТИ — це навмисна відсутність, а не забутий
