...
(function (root) {
    ...
    // а насправді сторінка вимагала токен, якого нізвідки взятись.
    //
    // Тепер увімкненою перевірка вважається лише тоді, коли віджет
    // справді намалювався й не повідомив про помилку.
    function enabled() {
        return Boolean(siteKey) && !failed && widgetId !== null;
    }
