...
(function () {
    ...
    window.openLightbox = function (imageList, startIndex, meta) {
        ...
        // Курсор — усередину, і Tab тримаємо там же.
        //
        // Лайтбокс накриває сторінку цілком, але фокус лишався на
        // фото, з якого його відкрили: Tab вів по картці й по всьому,
        // що під затемненням, а стрілки «попереднє/наступне» й
        // «Закрити» опинялись десь наприкінці обходу. Escape тут був
        // і раніше — тепер до нього є й решта.
        //
        // Через window.DialogFocus (common.js): та сама поведінка, що
        // у вікон .modal-overlay, і те саме повернення курсора при
        // закритті.
        window.DialogFocus?.open(root);
    ...
    function closeLightbox() {
        ...
        // Курсор назад на фото, з якого відкривали, — ДО того, як
        // сховаємо: у схованому елементі фокусувати вже нічого, а
        // браузер кине фокус на початок сторінки.
        window.DialogFocus?.close(root);
