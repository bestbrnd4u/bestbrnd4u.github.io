...
console.log("\n[11] Масштаб не накриває сусідні слайди");
{
    ...
    // Ім'я функції, а не її підпис: перевірка тут про те, ДЕ живе
    // розмітка, а не скільки в функції аргументів. Прив'язка до
    // «(product, img)» уже одного разу почервоніла від того, що
    // слайду додали третій аргумент (lazy/eager) — помилки при
    // цьому не було жодної.
    check("слайд малює одна функція",
        /function cardPhotoSlide\(/.test(ui)
