...
console.log("\n[4] Відлік читається людиною");
{
    ...
    // КРОК ГОДИННИКА. Поки лишились дні, рядок «6 дн. 04:12» частіше
    // за хвилину не міняється, а щосекундна перемальовка на телефоні
    // коштує батареї.
    check("далеко — раз на хвилину", api.promoTickMs(NOW + 2 * HOUR, NOW) === 60000);
