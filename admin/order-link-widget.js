...
(function () {
    ...
    function telegramLink(title, link) {
        ...
        // символами. «Доброго дня! Хочу замовити: <назва>» перетворює
        // посилання на 451 символ нечитабельного %D0%94%D0%BE… — таке
        // не вставиш ні в пост, ні в шапку профілю, і скопіювати
        // вручну неможливо.
        //
        // Прибрали вітання й назву — лишилось 127 символів. Втрати
        ...
        return "https://t.me/" + TELEGRAM + "?text=" + encodeURIComponent(link);
