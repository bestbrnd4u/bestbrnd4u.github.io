...
(function () {
    ...
    function telegramLink(title, link) {
        ...
        // Текст, який побачить покупець у полі введення. Назва плюс
        // посилання: без посилання ви не зрозумієте, який саме товар
        // мають на увазі, коли назви схожі.
        var text = "Доброго дня! Хочу замовити: " + title + "\n" + link;
        ...
        render: function () {
            ...
            return h("div", { className: "order-link-widget" },
                ...
                h(Row, {
                    ...
                    hint: "Відкриває чат із уже набраним повідомленням: назва "
                        + "товару й посилання. Покупцю лишається натиснути «надіслати»."
                }),
