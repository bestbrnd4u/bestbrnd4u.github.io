...
const JOBS = [
    // Плиток пошуку тут БІЛЬШЕ НЕМАЄ — і це навмисно.
    //
    // Раніше скрипт збирав їх колажем із фото товарів. Тепер під ці
    // плитки є справжні знімки, підготовлені окремо, і вони задаються
    // в адмінці («Сторінки» → «Картинки в пошуку»).
    //
    // Якби ці два завдання лишились, черговий `npm run banners`
    // мовчки перезаписав би готові знімки колажами — і зрозуміти, чому
    // картинки «самі повернулись назад», було б непросто.
    //
    // Мега-меню й фони головної генеруються далі: там колаж доречний.
